        ...
        <ul className="menuLists grid">
          <li className="listItem">
            ...
            {dropdownOpen.investigation && (
              <ul className="dropdownMenu">
                 <li>
                  <NavLink to={'/subinspector/home'} className="menuLink flex">
                    <AiOutlinePieChart className="icon" />
                    <span className="smallText">Personalized Dashboard</span>
                  </NavLink>
                </li>
                <li>
                  <NavLink to={'/subinspector/profile'} className="menuLink flex">
                    <IoMdSpeedometer className="icon" />
                    <span className="smallText">Personal Stats</span>
                  </NavLink>
                </li>
                <li>
                  <NavLink to={'/subinspector/addfir'} className="menuLink flex">
                    <FaLocationCrosshairs className="icon" />
                    <span className="smallText">FIR Register</span>
                  </NavLink>
                </li>
                <li>
                  <NavLink to={'/subinspector/firdetails'} className="menuLink flex">
          ...
          <li className="listItem">
            ...
            {dropdownOpen.lawAndOrder && (
              <ul className="dropdownMenu">
                <li>
                  <NavLink to={'/subinspector/beatlogs'} className="menuLink flex">
                    <IoMdSpeedometer className="icon" />
                    <span className="smallText">Beat Execution</span>
                  </NavLink>
                </li>
                <li>
                  <NavLink to={'/subinspector/beatdetails'} className="menuLink flex">
                    <FaLocationCrosshairs className="icon" />
                    <span className="smallText">Beat Details</span>
                  </NavLink>
                </li>
                <li>
                  <NavLink to={'/subinspector/beatdashboard'} className="menuLink flex">
                    <FaLocationCrosshairs className="icon" />
          ...
          <li className="listItem">
            ...
            {dropdownOpen.stationManagement && (
              <ul className="dropdownMenu">
                <li>
                  <NavLink to={'/subinspector/assigntasks'} className="menuLink flex">
                    <IoMdSpeedometer className="icon" />
                    <span className="smallText">Task Allocation</span>
                  </NavLink>
                </li>
                <li>
                  <NavLink to={'/subinspector/activeduties'} className="menuLink flex">
                    <IoMdSpeedometer className="icon" />
                    <span className="smallText">Active Duties</span>
                  </NavLink>
                </li>
                <li>
                  <NavLink to={'/subinspector/location'} className="menuLink flex">
                    <FaLocationCrosshairs className="icon" />
          ...
          {/* <li className="listItem">
            ...
            {dropdownOpen.crimeAnalysis && (
              <ul className="dropdownMenu">
                <li>
                  <NavLink to={'/subinspector/personalized-dashboard'} className="menuLink flex">
                    <AiOutlinePieChart className="icon" />
                    <span className="smallText">Personalized Dashboard</span>
                  </NavLink>
                </li>
          ...
          <li className="listItem">
            ...
            {dropdownOpen.courtInterface && (
              <ul className="dropdownMenu">
                {/* <li>
                  <NavLink to={'/subinspector/case-resolvance'} className="menuLink flex">
                    <GrUserPolice className="icon" />
                    <span className="smallText">Case Resolvance</span>
                  </NavLink>
                </li> */}
                <li>
                  <NavLink to={'/subinspector/case-related-dashboards'} className="menuLink flex">
